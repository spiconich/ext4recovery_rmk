...
class BlockMap2048 : public SearchType
{
    void info()
    {
        std::cout << std::endl;
        std::cout << "  Going to look for block map, using 2kb block size us detected" << std::endl;
        blocksaddr.resize(blocksaddr.size() + GLOBAL_num_of_groups);
    }
    bool discoveringIfBlockSetUsDeleted(unsigned long long sbOffset, unsigned long long foundedSignAddr, std::string fullPath)
    {   //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
/*
class BlockMap8192 : public SearchType
{
    void info()
    {
        std::cout << std::endl;
...
class Factory2048 : public Factory
{
public:
    SearchType* createSystemType()
    {
        return new BlockMap2048;
    }
};
*/
...
/*
class Factory8192 : public Factory
{
public:
    SearchType* createSystemType()
    {
        return new BlockMap8192;
    }
};*/
   ...
   /* if (blockSize == 1024)
    ...
    {*/
        ...
        else
        {
            ...
            {
                //if+2048
                Factory2048* factory2048 = new Factory2048;
                return factory2048->createSystemType();
            }
            else
            {
                if (blockSize == 8192)
                {
                    //if+2048
                    Factory8192* factory8192 = new Factory8192;
                    return factory8192->createSystemType();
                }
                else
                {
                    return NULL;
